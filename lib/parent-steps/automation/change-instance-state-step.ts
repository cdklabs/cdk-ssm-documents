...
export interface ChangeInstanceStateStepProps extends AutomationStepProps {
    ...
    /**
     * (Optional) If set, forces the instances to stop. The instances don't have an opportunity to flush file system caches or file system metadata. If you use this option, you must perform file system check and repair procedures. This option isn't recommended for EC2 instances for Windows Server.
     */
 ...
 */
 export class ChangeInstanceStateStep extends AutomationStep {
    ...
    private changeInstanceStateCall(endpoint: string, additionalParameters: Record<string, IGenericVariable | undefined>, inputs: Record<string, any>): void {
