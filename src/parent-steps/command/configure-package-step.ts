...
export interface ConfigurePackageStepProps extends CommandStepProps {
     ...
     */
    readonly packageName: IStringVariable;

    /**
     * Install or uninstall a package.
     */
    readonly packageAction: IStringVariable;
     ...
     */
    readonly  installationType?: IStringVariable
...
/**
 * AutomationStep implemenation for aws:configurePackage
